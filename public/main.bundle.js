    ...
    LoginComponent.prototype.onLoginSubmit = function () {
        ...
        this.authService.authenticateUser(user).subscribe(function (data) {
            if (data.success) {
                ...
                _this.flashMessage.show(_this.username + ' is now logged in!', { cssClass: 'alert-success', timeout: 5000 });
                _this.router.navigate(['dashboard']);
            }
            else {
                _this.flashMessage.show('Wrong username or password', { cssClass: 'alert-danger', timeout: 5000 });
...
var RegisterComponent = (function () {
    ...
    RegisterComponent.prototype.onRegisterSubmit = function () {
        ...
        this.authService.registerUser(user).subscribe(function (data) {
            if (data.success) {
                _this.flashMessage.show('User registered successfully! Please Log in', { cssClass: 'alert-success', timeout: 3000 });
                _this.router.navigate(['/login']);
            }
            else {
...
module.exports = "<div class=\"jumbotron text-center\">\n  <h1>Go Outside</h1>\n  <p class=\"lead\">A social newtworking designed for outdoorsie people</p><br>\n  <a class=\"btn btn-primary\" [routerLink]=\"['/register']\">Sign up</a>\n  <a class=\"btn btn-primary\" [routerLink]=\"['/login']\">Sign in</a>\n</div>\n\n<div class=\"row text-center\">\n  <div class=\"col-md-4\">\n    <h3>Events</h3>\n    <p>Create public and private events!</p>\n  </div>\n  <div class=\"col-md-4\">\n    <h3>Socialise</h3>\n    <p>Get to know people by attending local public events</p>\n  </div>\n  <div class=\"col-md-4\">\n    <h3>Be healthy</h3>\n    <p>Sports and a good diet leads to a much helthier life!</p>\n  </div>\n</div>\n"
...
var ValidateService = (function () {
    ...
    ValidateService.prototype.validateRegister = function (user) {
        if (user.name == undefined || user.email == undefined || user.password == undefined || user.country == undefined || user.username == undefined) {
            return false;
        }
        else {
            return true;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__components_dashboard_dashboard_component__ = __webpack_require__(100);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__components_profile_profile_component__ = __webpack_require__(104);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14_angular2_flash_messages__ = __webpack_require__(29);
